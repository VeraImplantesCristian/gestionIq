...
<template>
  <div class="space-y-12">
    ...
    <div class="space-y-8">
      ...
      <div data-field-key="consumo_realizado">
        ...
        <p v-if="errors.consumo_realizado" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ errors.consumo_realizado }}</p>
      </div>
      <div>
    ...
    <div class="space-y-8">
      <!-- NUEVO: Añadido data-field-key para el auto-scroll -->
      <div data-field-key="tipo_logistica">
        ...
        <!-- MODIFICADO: Añadida clase dark:text-red-400 para mejor contraste del error -->
        <p v-if="errors.tipo_logistica" class="text-red-500 dark:text-red-400 text-sm mt-2">{{ errors.tipo_logistica }}</p>
      </div>
      <div>
