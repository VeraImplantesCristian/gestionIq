...
<template>
  <div class="space-y-10">
    ...
    <div class="space-y-4" data-field-key="signature">
      ...
      <!-- MODIFICADO: Añadida clase dark:text-red-400 para mejor contraste del error -->
      <p v-if="errors.signature" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ errors.signature }}</p>
    </div>
    
    <!-- NUEVO: Añadido data-field-key para el auto-scroll -->
    <div data-field-key="acepta_terminos" class="space-y-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start space-x-3 dark:bg-yellow-500/10 dark:border-yellow-500/20">
      ...
      <div>
        ...
        <!-- MODIFICADO: Añadida clase dark:text-red-400 para mejor contraste del error -->
        <p v-if="errors.acepta_terminos" class="text-red-500 dark:text-red-400 text-sm ml-9">{{ errors.acepta_terminos }}</p>
      </div>
    </div>
  </div>
</template>
