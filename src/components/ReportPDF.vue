    ...
    <div v-if="reporte" class="flex flex-col h-full text-xs">
      ...
      <main class="flex-grow space-y-4 mt-4">
        ...
        <section>
          ...
          <!-- **NUEVO:** Bloque de Consumo destacado -->
          ...
          <div class="grid grid-cols-2 gap-x-6 mt-3">
            ...
            <div class="space-y-1 text-xs border p-2 rounded-md bg-slate-50">
              ...
              <!-- **NUEVO:** Usamos el formateador "humanize" -->
...
const props = defineProps({ 
  reporte: Object,
  instrumentadorDni: String, // **NUEVO:** Recibimos el DNI como prop
});
...
// **NUEVO:** Formateador para "humanizar" texto
const humanize = (text) => {
  if (!text) return 'N/A';
  return text.replace('_', ' ').replace(/\b\w/g, char => char.toUpperCase());
};

// --- COMPONENTES INTERNOS PARA EL PDF ---
