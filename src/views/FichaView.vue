...
<template>
  <div class="min-h-screen w-full bg-gradient-to-b from-blue-50 to-white flex flex-col items-center p-2 sm:p-6 lg:p-8 dark:bg-slate-900">
    ...
    <div class="w-full max-w-4xl">
      <Transition name="fade" mode="out-in">
        ...
        <div v-else-if="viewState === 'identification'" class="bg-white p-6 sm:p-8 rounded-2xl shadow-md w-full max-w-lg mx-auto dark:bg-slate-800">
           <div class="text-center mb-6">
             <img src="/1.svg" alt="Logo Districorr" class="h-10 sm:h-12 mx-auto mb-2">
             <h2 class="text-xl sm:text-2xl font-bold text-slate-800 dark:text-slate-100">Identificación del Profesional</h2>
        ...
        <FichaForm 
          v-else-if="viewState === 'form_display' && reporte && instrumentador" 
          :reporte="reporte" 
          :instrumentador-nombre="instrumentador.nombre_completo"
          :instrumentador-dni="instrumentador.dni" 
